...
public abstract class Player {
    ...
    Player(final Board board,
        ...
        this.isInCheck = !Player.calculateAttackOnTile(playerKing.getPiecePosition(), opponentMoves).isEmpty();
    }
    ...
    public MoveTransition makeMove(final Move move) {
        if (!isMoveLegal(move)) {
            return new MoveTransition(this.board, move, MoveStatus.ILLEGAL_MVOE);
        }
